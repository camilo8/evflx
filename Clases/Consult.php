...
class Evaluacion{
	...
	public function Eval($id){
	   $sql= "SELECT evaluacion.Criterio1 , evaluacion.Criterio2 , evaluacion.Criterio3, evaluacion.Criterio4 , evaluacion.Criterio5 , evaluacion.Criterio6, evaluacion.Criterio7 , evaluacion.Criterio8, evaluacion.Criterio9, evaluacion.DespcrionEstu , persona.Nombre , persona.Apellido , persona.Grado_id FROM evaluacion INNER JOIN persona ON evaluacion.Estudiante_id = persona.id WHERE Estudiante_id= :id";
	$this->id = $id;
